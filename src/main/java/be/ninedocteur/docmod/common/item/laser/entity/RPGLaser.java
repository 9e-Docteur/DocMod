...
public class RPGLaser extends AbstractRPGLaser {
    ...
    public RPGLaser(EntityType<? extends RPGLaser> p_36858_, Level p_36859_) {
        super(p_36858_, p_36859_);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }

    public RPGLaser(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {
        super(DMEntityType.RPG_LASER.get(), p_36862_, p_36863_, p_36864_, p_36861_);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }

    public RPGLaser(Level p_36866_, LivingEntity p_36867_) {
        super(DMEntityType.RPG_LASER.get(), p_36867_, p_36866_);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }
    ...
    static {
        ID_EFFECT_COLOR = SynchedEntityData.defineId(RPGLaser.class, EntityDataSerializers.INT);
    }
}
