...
public abstract class ClassicDalekLaserGunItem extends Item {
    public ClassicDalekLaserGunItem(Properties pProperties) {
        super(pProperties);
    }

    public static final Predicate<ItemStack> CYBERGUN_LASER_ONLY = (p_43017_) -> {
        return p_43017_.is(DMItems.CLASSIC_DALEK_LASER.get());
    };
