...
public class DMItems {
    ...
    public static final RegistryObject<Item> CRYSTALINE = ITEMS.register("crystaline", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CRYSTAL = ITEMS.register("crystal", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    //public static final RegistryObject<Item> RAW_SAPHIR = ITEMS.register("raw_saphir", () -> new Item(new Item.Properties().rarity(Rarity.EPIC)));
    //public static final RegistryObject<Item> SAPHIR = ITEMS.register("saphir", () -> new Item(new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> ZINC_NUGGET = ITEMS.register("zinc_nugget", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HALFINUM_NUGGET = ITEMS.register("halfinum_nugget", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CRYOLITE = ITEMS.register("cryolite", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LIGHT_BLUE_BRICKS_INGOT = ITEMS.register("light_blue_bricks_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> GREEN_BRICKS_INGOT = ITEMS.register("green_bricks_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> YELLOW_BRICKS_INGOT = ITEMS.register("yellow_bricks_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> BLUE_BRICKS_INGOT = ITEMS.register("blue_bricks_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HALFINUM_INGOT = ITEMS.register("halfinum_ingot", () -> new HalfinumIngot(new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> FUEL = ITEMS.register("fuel", () -> new Item(new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> WHITE_POINTED_STAR = ITEMS.register("white_pointed_star", () -> new WhitePointedStar(new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> STEEL_INGOT = ITEMS.register("steel_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> RAW_STEEL_INGOT = ITEMS.register("raw_steel_ingot", () -> new Item(new Item.Properties()));
    //public static final RegistryObject<Item> GAZOLINE_BUCKET = ITEMS.register("gazoline_bucket", () -> new BucketItem(DMFluids.SOURCE_GAZOLINE, new Item.Properties().stacksTo(1).craftRemainder(Items.BUCKET)));

    /*
    FOOD
     */
    public static final RegistryObject<Item> BELGIUM_FRIES = ITEMS.register("belgium_fries", () -> new FriesFoodItem(new Item.Properties().food(new FoodProperties.Builder().effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 100, 2), 0.2f).nutrition(2).saturationMod(1).alwaysEat().build())));
    public static final RegistryObject<Item> TEA = ITEMS.register("tea", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(1).alwaysEat().build())));
    public static final RegistryObject<Item> COFFEE = ITEMS.register("coffee", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200, 2), 1f).effect(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 200, 3), 1f).nutrition(2).saturationMod(1).alwaysEat().build())));
    public static final RegistryObject<Item> JUPILER = ITEMS.register("jupiler", () -> new JupilerFoodItem(new Item.Properties().food(new FoodProperties.Builder().effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 150, 2), 0.5f).effect(() -> new MobEffectInstance(MobEffects.POISON, 20, 3), 0.2f).effect(() -> new MobEffectInstance(MobEffects.HUNGER, 100, 2), 0.4f).nutrition(2).saturationMod(0.2f).alwaysEat().build())));
    ...
    public static final RegistryObject<Item> ICE_CREAM = ITEMS.register("ice_cream", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 100, 2), 0.2f).nutrition(4).saturationMod(1).alwaysEat().build())));
    public static final RegistryObject<Item> HAMBURGER = ITEMS.register("hamburger", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 100, 2), 0.2f).nutrition(8).saturationMod(2).alwaysEat().build())));
    public static final RegistryObject<Item> DOCTEAM_COLA = ITEMS.register("docteam_cola", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(2).alwaysEat().build())));
    ...
    public static final RegistryObject<Item> ZINC_SWORD = ITEMS.register("zinc_sword", () -> new SwordItem(ModItemTier.ZINC, 6, 3f, new Item.Properties()));
    public static final RegistryObject<Item> ZINC_PICKAXE = ITEMS.register("zinc_pickaxe", () -> new PickaxeItem(ModItemTier.ZINC, 0, -1f, new Item.Properties()));
    public static final RegistryObject<Item> ZINC_AXE = ITEMS.register("zinc_axe", () -> new AxeItem(ModItemTier.ZINC, 0, -1f, new Item.Properties()));
    public static final RegistryObject<Item> STAFF = ITEMS.register("staff", () -> new StaffItem(ModItemTier.ZINC, 0, -1f, new Item.Properties()));
    public static final RegistryObject<Item> TARDIS_KEY = ITEMS.register("tardis_key", () -> new TardisKeyItem(new Item.Properties()));
    public static final RegistryObject<Item> ALBIZIA_STICK = ITEMS.register("albizia_stick", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HALFINUM_AXE = ITEMS.register("halfinum_axe", () -> new AxeItem(ModItemTier.HALFINUM, 0, -1f, new Item.Properties()));
...
//    public static final RegistryObject<Item> KNOWCKBACK_STICK = ITEMS.register("knockback_stick", () -> new KnockbackStick(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CYBERMAN_EGG = ITEMS.register("cyberman_spawn", () -> new ForgeSpawnEggItem(DMEntityType.CYBERMAN, 0xffffff, 0xffffff,new Item.Properties()));
    public static final RegistryObject<Item> CYBERBOSS_EGG = ITEMS.register("cyberboss_spawn", () -> new ForgeSpawnEggItem(DMEntityType.CYBERBOSS, 0xffffff, 0xffffff,new Item.Properties()));
    public static final RegistryObject<Item> CYBERHUMAN_EGG = ITEMS.register("cyberhuman_spawn", () -> new ForgeSpawnEggItem(DMEntityType.CYBERHUMAN, 0xffffff, 0xffffff,new Item.Properties()));
    public static final RegistryObject<Item> CYBERHUMAN_2_EGG = ITEMS.register("cyberhuman_2_spawn", () -> new ForgeSpawnEggItem(DMEntityType.CYBERHUMAN_2, 0xffffff, 0xffffff,new Item.Properties()));
    public static final RegistryObject<Item> CYBERHUMAN_3_EGG = ITEMS.register("cyberhuman_3_spawn", () -> new ForgeSpawnEggItem(DMEntityType.CYBERHUMAN_3, 0xffffff, 0xffffff,new Item.Properties()));
    public static final RegistryObject<Item> DALEK_EGG = ITEMS.register("dalek_spawn", () -> new ForgeSpawnEggItem(DMEntityType.DALEK, 0xffffff, 0xffffff,new Item.Properties()));
    public static final RegistryObject<Item> SWDALEK_EGG = ITEMS.register("swdalek_spawn", () -> new ForgeSpawnEggItem(DMEntityType.SWDALEK, 0xffffff, 0xffffff,new Item.Properties()));
    //public static final RegistryObject<Item> ADIPOSE_EGG = ITEMS.register("adipose_spawn", () -> new ForgeSpawnEggItem(DMEntityType.ADIPOSE, 0xffffff, 0xffffff,new Item.Properties()));

    //LASER
    public static final RegistryObject<Item> CYBER_LASER = ITEMS.register("cyber_laser", () -> new LaserItem(new Item.Properties()));
    public static final RegistryObject<Item> DALEK_LASER = ITEMS.register("dalek_laser", () -> new DalekLaserItem(new Item.Properties()));
    public static final RegistryObject<Item> RPG_LASER = ITEMS.register("rpg_laser", () -> new RPGItem(new Item.Properties()));
    public static final RegistryObject<Item> MAGIC_LASER = ITEMS.register("magic_ammo", () -> new MagicLaserItem(new Item.Properties()));
    public static final RegistryObject<Item> CLASSIC_DALEK_LASER = ITEMS.register("classic_dalek_laser", () -> new ClassicDalekLaserItem(new Item.Properties()));

    //GUN
    public static final RegistryObject<Item> CYBER_GUN = ITEMS.register("cyber_gun", () -> new CyberGun(new Item.Properties().durability(2500)));
    public static final RegistryObject<Item> DALEK_GUN = ITEMS.register("dalek_gun", () -> new DalekGun(new Item.Properties().durability(2500)));
    public static final RegistryObject<Item> RPG_GUN = ITEMS.register("rpg_gun", () -> new RPGGun(new Item.Properties().durability(2500)));
   ...
   // public static final RegistryObject<Item> VENTIRAD = ITEMS.register("ventirad", () -> new Ventirad(new Item.Properties().durability(2500).tab(DMCreativeTabs.COMPUTER)));
    ...
    public static final RegistryObject<Item> ROUND_THING_FRAME = ITEMS.register("round_thing_frame", () -> new Item((new Item.Properties())));
    public static final RegistryObject<Item> RED_ROUND_THING_FRAME = ITEMS.register("red_round_thing_frame", () -> new Item((new Item.Properties())));
    public static final RegistryObject<Item> BLUE_ROUND_THING_FRAME = ITEMS.register("blue_round_thing_frame", () -> new Item((new Item.Properties())));
