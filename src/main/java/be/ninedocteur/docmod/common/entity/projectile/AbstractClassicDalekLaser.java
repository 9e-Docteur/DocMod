...
public abstract class AbstractClassicDalekLaser extends Projectile {
    ...
    public AbstractClassicDalekLaser.Pickup pickup;
    ...
    protected AbstractClassicDalekLaser(EntityType<? extends AbstractClassicDalekLaser> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
        this.pickup = AbstractClassicDalekLaser.Pickup.DISALLOWED;
        this.baseDamage = 10.0D;
    }

    protected AbstractClassicDalekLaser(EntityType<? extends AbstractClassicDalekLaser> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        this(p_36711_, p_36715_);
        this.setPos(p_36712_, p_36713_, p_36714_);
    }

    protected AbstractClassicDalekLaser(EntityType<? extends AbstractClassicDalekLaser> p_36717_, LivingEntity p_36718_, Level p_36719_) {
        ...
        if (p_36718_ instanceof Player) {
            this.pickup = AbstractClassicDalekLaser.Pickup.ALLOWED;
        }
    ...
    public void tick() {
        ...
        if (this.inGround && !flag) {
           ...
           // this.setNoPhysics(true);
            ...
            this.level.addParticle(DMParticles.CLASSIC_DALEK_PARTICLES.get(), this.getX() + d5 *4.0D, this.getY() + d6 * 4.0D, this.getZ() + d1 * 4.0D, -d5, -d6 + 0.2D, -d1);
        }
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (entity1 == null) {
            damagesource = DMDamageSource.classicDalekLaser(this, this);
        } else {
            damagesource = DMDamageSource.classicDalekLaser(this, entity1);
        ...
        if (entity.hurt(damagesource, (float)i)) {
            ...
            if (!this.level.isClientSide && this.getDeltaMovement().lengthSqr() < 1.0E-7D) {
                if (this.pickup == AbstractClassicDalekLaser.Pickup.ALLOWED) {
    ...
    protected void onHitBlock(BlockHitResult p_36755_) {
        ...
        //level.addParticle(ParticleTypes.CLOUD, pos.getX() + rand.nextDouble(), pos.getY() + 0.5D, pos.getZ() + rand.nextDouble(), 0d, 0.08d, 0d);
    }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.pickup = AbstractClassicDalekLaser.Pickup.byOrdinal(pCompound.getByte("pickup"));
    ...
    public void setOwner(@Nullable Entity pEntity) {
        ...
        if (pEntity instanceof Player) {
            this.pickup = ((Player)pEntity).getAbilities().instabuild ? AbstractClassicDalekLaser.Pickup.CREATIVE_ONLY : AbstractClassicDalekLaser.Pickup.ALLOWED;
        }
    ...
    static {
        ID_FLAGS = SynchedEntityData.defineId(AbstractClassicDalekLaser.class, EntityDataSerializers.BYTE);
        PIERCE_LEVEL = SynchedEntityData.defineId(AbstractClassicDalekLaser.class, EntityDataSerializers.BYTE);
    }
