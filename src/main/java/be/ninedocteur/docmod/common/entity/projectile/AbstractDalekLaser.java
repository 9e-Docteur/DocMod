...
public abstract class AbstractDalekLaser extends Projectile {
    ...
    public AbstractDalekLaser.Pickup pickup;
    ...
    protected AbstractDalekLaser(EntityType<? extends AbstractDalekLaser> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
        this.pickup = AbstractDalekLaser.Pickup.DISALLOWED;
        this.baseDamage = 10.0D;
    }

    protected AbstractDalekLaser(EntityType<? extends AbstractDalekLaser> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        this(p_36711_, p_36715_);
        this.setPos(p_36712_, p_36713_, p_36714_);
    }

    protected AbstractDalekLaser(EntityType<? extends AbstractDalekLaser> p_36717_, LivingEntity p_36718_, Level p_36719_) {
        ...
        if (p_36718_ instanceof Player) {
            this.pickup = AbstractDalekLaser.Pickup.ALLOWED;
        }
...
//        if (entity1 == null) {
//            damagesource = DMDamageSource.dalekLaser(this, this);
//        } else {
//            damagesource = DMDamageSource.dalekLaser(this, entity1);
...
//                if (this.pickup == AbstractDalekLaser.Pickup.ALLOWED) {
...
//        }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.pickup = AbstractDalekLaser.Pickup.byOrdinal(pCompound.getByte("pickup"));
    ...
    public void setOwner(@Nullable Entity pEntity) {
        ...
        if (pEntity instanceof Player) {
            this.pickup = ((Player)pEntity).getAbilities().instabuild ? AbstractDalekLaser.Pickup.CREATIVE_ONLY : AbstractDalekLaser.Pickup.ALLOWED;
        }
    ...
    static {
        ID_FLAGS = SynchedEntityData.defineId(AbstractDalekLaser.class, EntityDataSerializers.BYTE);
        PIERCE_LEVEL = SynchedEntityData.defineId(AbstractDalekLaser.class, EntityDataSerializers.BYTE);
    }
