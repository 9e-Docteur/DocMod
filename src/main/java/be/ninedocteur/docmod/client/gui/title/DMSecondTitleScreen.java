...
@OnlyIn(Dist.CLIENT)
public class DMSecondTitleScreen extends Screen {
    ...
    private Button infoButton, empty, multiPlayer, Quit;
    protected int leftPos;
    protected int topPos;
    private ResourceLocation headResource;

    public DMSecondTitleScreen() {
        this(false);
    }

    public DMSecondTitleScreen(boolean pFading) {
    ...
    private void createNormalMenuOptions(int p_96764_, int p_96765_) {
        ...
        Button.OnTooltip button$ontooltip = flag ? Button.NO_TOOLTIP : new Button.OnTooltip() {
            ...
            public void onTooltip(Button p_169458_, PoseStack p_169459_, int p_169460_, int p_169461_) {
                if (!p_169458_.active) {
                    DMSecondTitleScreen.this.renderTooltip(p_169459_, DMSecondTitleScreen.this.minecraft.font.split(this.text, Math.max(DMSecondTitleScreen.this.width / 2 - 43, 170)), p_169460_, p_169461_);
                }
        ...
        if (DMConfig.Client.showWidget.get()) {
            Button configButton = new ImageButton(this.width / 2 - 210, this.height / 4 + 48 -106, 16, 16, 0, 96, new ResourceLocation(DocMod.MOD_ID, "textures/gui/widgets.png"), (button -> {
                this.minecraft.setScreen(new DocModConfigScreen(this));
            }));
            Button discordButton = new ImageButton(this.width / 2 - 190, this.height / 4 + 48 -106, 16, 16, 0, 0, new ResourceLocation(DocMod.MOD_ID, "textures/gui/widgets.png"), (button -> {
                URLUtils.openLink(DMUtils.getDiscordLink());
            }));
            Button youtubeButton = new ImageButton(this.width / 2 - 170, this.height / 4 + 48 -106, 16, 16, 0, 64, new ResourceLocation(DocMod.MOD_ID, "textures/gui/widgets.png"), (button -> {
            ...
            empty = new ImageButton(this.width / 2 - 40, this.height / 4 + 48 -20, 21 *2 *2 + 4, 21 *2 *2 + 4, 0, 0, new ResourceLocation(DocMod.MOD_ID, "textures/gui/title/empty.png"), (button -> {
                this.minecraft.setScreen(new DocModPlayerScreen(this));
            }));

            multiPlayer = new ImageButton(this.width / 2 -140, this.height / 4 + 48 - 20, 21 *2 *2 + 4, 21 *2 *2 + 4, 0, 0, new ResourceLocation(DocMod.MOD_ID, "textures/gui/title/dm_servers.png"), (button -> {
                this.minecraft.setScreen(new DocModServersSelection(this));
            }));

            Quit = new ImageButton(this.width / 2 + 60, this.height / 4 + 48- 20, 21 *2 *2 + 4, 21 *2 *2 + 4, 0, 0, new ResourceLocation(DocMod.MOD_ID, "textures/gui/title/mods.png"), (button -> {
            ...
            this.addRenderableWidget(new ImageButton(this.width / 2 - 200, this.height / 4 + -60 + 120, 20 * 2 * 2 -0, 9 * 2 * 2 -0, 0, 0, new ResourceLocation(DocMod.MOD_ID, "textures/gui/title/back.png"), (p_96781_) -> {
                this.minecraft.setScreen(new DMTitleScreen(this.passEvents));
            }));
           ...
           // }));
            ...
            this.addRenderableWidget(multiPlayer);
    ...
    public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
        ...
        if ((l & -67108864) != 0) {
            ...
            RenderSystem.setShader(GameRenderer::getPositionTexShader);
            RenderSystem.setShaderTexture(0, PlayerUtils.get3DPlayerHead(Minecraft.getInstance().getUser().getUuid()));
            RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
            blit(p_96739_, empty.x + 14, empty.y + 16, 0, 0, 60, 55, 60, 55);
            ...
            drawString(p_96739_, this.font, "This is a Beta. The mod can contains bugs.", this.copyrightX + 30, this.height - 30, ColorUtils.getRed() | l);
            ...
            drawString(p_96739_, this.font, "Page : 2 / " + TitleScreenUtils.getMaxTitleScreen(), empty.x + 14, this.height - 50, 16777215 | l);
            }
            ...
            if(empty.isHoveredOrFocused()){
                drawString(p_96739_, font, "Player Info", empty.x + 14, empty.y +90, ColorUtils.getWhite());
            }

            if(multiPlayer.isHoveredOrFocused()){
                drawString(p_96739_, font, "DocMod Servers", multiPlayer.x + 5, multiPlayer.y +90, ColorUtils.getWhite());
            }

            if(Quit.isHoveredOrFocused()){
                drawString(p_96739_, font, "Mods", Quit.x + 28, Quit.y +90, ColorUtils.getWhite());
            }
