        ...
        Thread thread = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
            public void run() {
                ...
                try {
                    ...
                    DMConnectScreen.this.connection.setListener(new ClientHandshakePacketListenerImpl(DMConnectScreen.this.connection, p_169265_, DMConnectScreen.this.parent, DMConnectScreen.this::updateStatus));
