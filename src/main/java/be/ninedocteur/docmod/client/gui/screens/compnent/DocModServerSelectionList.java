...
import be.ninedocteur.docmod.client.gui.screens.DocModServersSelection;
...
@OnlyIn(Dist.CLIENT)
public class DocModServerSelectionList /*extends ObjectSelectionList<DocModServerSelectionList.Entry>*/ {
/*
    ...
    private final DocModServersSelection screen;
    ...
    public DocModServerSelectionList(DocModServersSelection pScreen, Minecraft pMinecraft, int pWidth, int pHeight, int pY0, int pY1, int pItemHeight) {
    ...
    public boolean keyPressed(int pKeyCode, int pScanCode, int pModifiers) {
        Entry DocModServerSelectionList$entry = this.getSelected();
        return DocModServerSelectionList$entry != null && DocModServerSelectionList$entry.keyPressed(pKeyCode, pScanCode, pModifiers) || super.keyPressed(pKeyCode, pScanCode, pModifiers);
    }

    protected void moveSelection(AbstractSelectionList.SelectionDirection pOrdering) {
        this.moveSelection(pOrdering, (p_169973_) -> {
            return !(p_169973_ instanceof LANHeader);
        });
    }

    public void updateOnlineServers(DocModServerList p_99798_) {
    ...
    public static class LANHeader extends Entry {
        ...
        public void render(PoseStack pPoseStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTick) {
            ...
            this.minecraft.font.draw(pPoseStack, SCANNING_LABEL, (float)(this.minecraft.screen.width / 2 - this.minecraft.font.width(SCANNING_LABEL) / 2), (float)i, 16777215);
            String s;
    ...
    public static class NetworkServerEntry extends Entry {
        ...
        protected NetworkServerEntry(DocModServersSelection pScreen, LanServer pServerData) {
            this.screen = pScreen;
    ...
    public class OnlineServerEntry extends Entry {
        ...
        protected OnlineServerEntry(DocModServersSelection p_99864_, ServerData p_99865_) {
        ...
        public boolean keyPressed(int pKeyCode, int pScanCode, int pModifiers) {
            if (Screen.hasShiftDown()) {
                DocModServerSelectionList DocModServerSelectionList = DocModServersSelection.serverSelectionList;
                int i = DocModServerSelectionList.children().indexOf(this);
                if (i == -1) {
                    return true;
                }
        ...
        private void swap(int p_99872_, int p_99873_) {
            ...
            DocModServersSelection.serverSelectionList.updateOnlineServers(this.screen.getServers());
            Entry DocModServerSelectionList$entry = DocModServersSelection.serverSelectionList.children().get(p_99873_);
            DocModServersSelection.serverSelectionList.setSelected(DocModServerSelectionList$entry);
            DocModServerSelectionList.this.ensureVisible(DocModServerSelectionList$entry);
        }

        public boolean mouseClicked(double pMouseX, double pMouseY, int pButton) {
            double d0 = pMouseX - (double) DocModServerSelectionList.this.getRowLeft();
            double d1 = pMouseY - (double) DocModServerSelectionList.this.getRowTop(DocModServerSelectionList.this.children().indexOf(this));
            if (d0 <= 32.0D) {
                ...
                int i = DocModServersSelection.serverSelectionList.children().indexOf(this);
