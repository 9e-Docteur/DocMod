...
public class CyberLaserRenderer<T extends AbstractLaser> extends EntityRenderer<T> {
    public CyberLaserRenderer(EntityRendererProvider.Context p_173917_) {
        super(p_173917_);
    }
    ...
    public void render(T pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        if ($$16 > 0.0F) {
            ...
            pMatrixStack.mulPose(Axis.ZP.rotationDegrees($$17));
        }
    ...
    public ResourceLocation getTextureLocation(T t) {
        return new ResourceLocation(DocMod.MOD_ID, "textures/entity/projectiles/cyber_laser.png");
    }
