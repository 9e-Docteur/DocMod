...
public class AwardUtils {
    ...
    public static class Award {
        ...
        public Award(String uuid, Awards... award) {
            ...
            for (int x = 0; x < award.length; x++)
                awardsBuilder.append(award[x].colorName).append(ChatFormatting.WHITE).append((x + 1 != award.length) ? ", " : "");
    ...
    enum Awards {
        HUGE_DEV(ChatFormatting.DARK_AQUA, "Huge Dev"), NO_AWARDS(ChatFormatting.RED, "No Awards"), HUGE_CONTRIBUTOR(ChatFormatting.AQUA, "Huge Contributor"), BEST_FRIEND(ChatFormatting.BLUE, "Best Friend <3"),
        NinetyConfirmed(ChatFormatting.GREEN, "Ninety-Confirmed");

        private final String colorName;

        Awards(ChatFormatting chatFormatting, String defaultNaming) {
