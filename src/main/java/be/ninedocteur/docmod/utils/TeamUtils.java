...
public class TeamUtils {
    ...
    public static class TeamMember {
        ...
        public TeamMember(String uuid, Title... title) {
            ...
            for (int x = 0; x < title.length; x++)
                titlesBuilder.append(title[x].colorName).append(ChatFormatting.WHITE).append((x + 1 != title.length) ? ", " : "");
    ...
    public enum Title {
        FOUNDER(ChatFormatting.RED, "Founder"), ADMIN(ChatFormatting.RED, "Admin"),
        DEVELOPER(ChatFormatting.AQUA, "Developer"), FRIEND(ChatFormatting.GREEN, "Friend"),
        CONTRIBUTOR(ChatFormatting.BLUE, "Contributor"), ASSETS_MANAGER(ChatFormatting.DARK_PURPLE, "Assets Manager"),
        BETA(ChatFormatting.DARK_BLUE, "Beta"), PLAYER(ChatFormatting.WHITE, "Player");

        private final String colorName;

        Title(ChatFormatting chatFormatting, String defaultNaming) {
            this.colorName = chatFormatting + defaultNaming;
        }
    }
}
