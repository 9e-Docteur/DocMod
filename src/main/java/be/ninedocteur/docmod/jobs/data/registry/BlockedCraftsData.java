...
public class BlockedCraftsData {
     ...
     */
    public BlockedCraftsData(FriendlyByteBuf buf){
    ...
    public static class BlockedCraft{
         ...
         * @param buf the buffer where to read
         */
        public BlockedCraft(FriendlyByteBuf buf) {
        ...
        public UnlockStack getUnlockStack(){
            return new UnlockStack(level, JobsUtil.itemStack(craft, 1, metadata), BlockedData.Type.CRAFTING);
        }
    }
