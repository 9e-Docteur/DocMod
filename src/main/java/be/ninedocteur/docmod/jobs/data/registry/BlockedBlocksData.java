...
public class BlockedBlocksData {
     ...
     */
    public BlockedBlocksData(FriendlyByteBuf buf){
    ...
    public static class BlockedBlock{
         ...
         * @param buf the buffer where to read
         */
        public BlockedBlock(FriendlyByteBuf buf) {
        ...
        public UnlockStack getUnlockStack(){
            return new UnlockStack(level, new ItemStack(block, 1), BlockedData.Type.BREAKING);
        }
}
}
