...
package fr.ninedocteur.docmod.integrations.discord.rpc;
...
public interface DiscordRPC extends Library
{
     ...
     */
    void Discord_Initialize(@NonnullDefault String applicationId,
     ...
     */
    void Discord_Respond(@NonnullDefault String userid, int reply);
